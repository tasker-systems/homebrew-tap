...
def main() -> int:
    ...
    mac_manifest_sha = hashlib.sha256(args.mac_manifest.read_bytes()).hexdigest()
    linux_manifest_sha = hashlib.sha256(args.linux_manifest.read_bytes()).hexdigest()

    text = render(args.version, args.mac_sha, args.linux_sha)
